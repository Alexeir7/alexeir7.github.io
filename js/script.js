...
if (prevScrollpos > currentScrollPos) {
    ...
    document.getElementById("header").style.boxShadow = "0px 15px 35px rgba(1, 1, 1,0.5)";
    document.getElementById("logo").style.boxShadow = " 4px 4px 25px hsla(232, 100%, 50%,0.5)";
    } else {
